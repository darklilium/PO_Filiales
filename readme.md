...
<i>Español</i>
<h1>Proyecto inicial de Clientes Interrumpidos para filiales.</h1>

<strong>Objetivo: Crear una app web que permita mostrar los clientes interrumpidos de una filial seleccionada y su información de acuerdo a la orden.</strong>
