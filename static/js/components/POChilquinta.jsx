...
class POChilquinta extends React.Component {
  constructor(props){
    super(props);
    this.state = {
      xCoor: 0,
  ...
  componentDidMount(){
    ...
    var map = mymap.createMap("map_div","topo",this.state.xCoor ,this.state.yCoor,9);
    ...
    <div className="interruptions__symbology"><img className="interruptions__symbology-img"/></div>
      ...
      <div className="interruptions_chooseFilial">
        <Breadcrumb className="dashboard_breadcrum">
          ...
          <Breadcrumb.Item href="linares.html">
            Linares
          </Breadcrumb.Item>
          <Breadcrumb.Item href="litoral.html">
            Litoral
          </Breadcrumb.Item>
          <Breadcrumb.Item href="parral.html">
            Parral
          </Breadcrumb.Item>
        </Breadcrumb>
      </div>
